# Examples of Group Supervision Sessions {#supervision_examples}
...
Here is a [copy of the excerpts we use for the Discussion evaluation activity](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/EZnXNcupuYpPvtTctLIQHP4BPpKRakEyzQjnrhInkfOSHg?e=Sk2bCi){target="_blank"}. 
...
We have developed some [notes for staff](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/ERJe-GFNvg9GlKjPGDFmjL0BftYJBXBcvzw8U9ofZ1XH-Q?e=dnLOfb){target="_blank"} running this activity, with some of the strengths/limitations for each of the excerpts. 
...
- Lightning talk
- [Bright Club](https://en.wikipedia.org/wiki/Bright_Club){target="_blank"}/[Pint of Science](https://pintofscience.co.uk/){target="_blank"} talks
- Panel discussion
...
In a previous group session, I will have shared some of my [tips on presenting](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/EQh-1I7HCsBGkpcK6WmxPUUB_7JmqoRw1LINLhLWATig6w?e=JLiVho){target="_blank"}, as well as some suggestions from [Portsmouth University](https://myport.port.ac.uk/study-skills/speaking-skills-and-presentations){target="_blank"}. I share these again with the students in advance of the group session. 
